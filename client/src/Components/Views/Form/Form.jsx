  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setSubmitted(true);
        setState({  // Reinicia el estado del formulario a un objeto vacío
          name: "",
          image: "",
          brand: "",
          description: "",
      ...
      <div className="form-container">
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.name && <label className="form-error">{error.name}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.image && <label className="form-error">{error.image}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.brand && <label className="form-error">{error.brand}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></textarea>
            {error.description && <label className="form-error">{error.description}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.price && <label className="form-error">{error.price}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.stock && <label className="form-error">{error.stock}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.maker && <label className="form-error">{error.maker}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.model && <label className="form-error">{error.model}</label>}
          </div>
          ...
          <div className="form-group">
            ...
            ></input>
            {error.visible && <label className="form-error">{error.visible}</label>}
          </div>
